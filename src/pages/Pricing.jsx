...
const mouseleave=()=>{
  ...
  <div className="py-8 px-4 mx-auto max-w-screen-2xl lg:pb-32  xl:px-36 ">
      ...
      <div className="space-y-12 md:grid lg:grid-cols-4 lg:gap-0 md:grid-cols-2 gap-3  px-14  lg:space-y-0 flex justify-center  items-center flex-wrap">
           {/* card 1  */}
          <div className="mt-12 lg:mt-0 flex flex-col p-6  pt-[50px] max-w-sm text-center  shadow-lg bg-[#FFFFFF] hover:border hover:border-[#106466] hover:shadow-md lg:border-0 border border-[#106466] [0_35px_60px_-15px_#3CCF8E1A] relative overflow-hidden transition-transform transform-gpu duration-100 lg:hover:scale-y-110 h-fit cursor-pointer hover:z-10 " onMouseEnter={mouseover} onMouseLeave={mouseleave}>
              <h3 className="mb-1 text-[14px] font-semibold font-jost capitalize">bronze</h3>
             
              <div className="flex justify-center items-baseline mb-8 px-10">
                  <h3 className="text-[#8F8A8A] font-jost text-[16px]capitalize">$<span className="text-[#2E2E2E] font-[600] xl:text-[30px] text-[25px] ">99.99</span>/monthly</h3>
          ...
          {/* card 2  */}
          <div className="flex flex-col p-6  pt-[50px] max-w-sm text-center  shadow-lg bg-[#FFFFFF] hover:border hover:border-[#106466] hover:shadow-md[0_35px_60px_-15px_#3CCF8E1A] relative overflow-hidden transition-transform transform-gpu duration-100 lg:hover:scale-y-110 h-fit cursor-pointer hover:z-10" onMouseEnter={mouseover} onMouseLeave={mouseleave}>
              <h3 className="mb-1 text-[14px] font-semibold font-jost capitalize">Silver</h3>
          ...
          {/* card 3 */}
          <div className={`flex flex-col p-6 pt-4  max-w-sm text-center  shadow-lg bg-[#FFFFFF]  hover:shadow-md  [0_35px_60px_-15px_#3CCF8E1A] relative overflow-hidden transition-transform transform-gpu duration-100  h-fit cursor-pointer z-10 ${mousehover?'':'lg:scale-y-110  border border-[#106466]'}`}>
