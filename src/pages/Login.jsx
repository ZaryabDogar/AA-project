...
const Login = () => {
	return (
		<section className="md:h-[1050px] pt-10 md:bg-[url('/mainbg.png')] bg-center  bg-no-repeat xl:bg-[length:70%]  lg:bg-[length:70%] bg-[length:80%] bg-[#000000]">
			<div className="text-black lg:p-20 lg:pt-14 lg:pb-10 sm:p-10 p-5  flex md:justify-between md:flex-row flex-col justify-center md:items-start">
				...
				<div className="flex flex-col lg:space-y-10 space-y-5 xl:w-[52%] text-center md:text-start ">
					...
					<p className="font-jost font-[500] text-[18px]  leading-[27.7px] text-[#F5F5F5] md:w-[75%]">
					Using advanced techniques in AI Steganography & Layered encryption your data can be securely hidden or extracted.
					</p>
				</div>
				...
				<div className="flex flex-col justify-center items-center space-y-4   mt-16 ">
					<div className=" ">
						<input
							...
							placeholder-shown:text-[#4B4B4B] placeholder-shown:leading-[27px] xl:w-[500px] xl:h-[68px] md:w-[300px] w-[300px]    py-3 px-4"
						/>
					</div>
					<div className="">
						<input
							...
							className="appearance-none outline-none bg-input placeholder-shown:font-nunito placeholder-shown:font-[400] placeholder-shown:text-[18px] placeholder-shown:leading-[27px] xl:w-[500px] xl:h-[68px] md:w-[300px] w-[300px]  py-3 px-4"
						/>
					</div>
