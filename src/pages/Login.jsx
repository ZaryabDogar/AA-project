...
const Login = () => {
	return (
		<section className="md:h-[1100px] pt-0 md:bg-[url('/mainbg.png')] bg-center  bg-no-repeat xl:bg-[length:90%]  lg:bg-[length:70%] bg-[length:80%] bg-darkgreen">
			<div className="text-black lg:p-20 lg:pt-14 lg:pb-10 sm:p-10 p-5  flex md:justify-between md:flex-row flex-col justify-center md:items-start">
				...
				<div className="flex flex-col lg:space-y-10 space-y-5 xl:w-[52%] text-center md:text-start ">
					<p className="font-[900] lg:text-[40px] md:text-[30px] sm:text-[40px] text-[35px]  lg:leading-[60px] leading-[50px] text-white font-nunito">
				...
				<div className="flex flex-col justify-center items-center space-y-4   mt-16">
					<div className="">
						<input
							...
							placeholder-shown:text-[#4B4B4B] placeholder-shown:leading-[27px] xl:w-[500px] md:w-[300px] w-full    py-3 px-4"
						/>
					</div>
					<div className="">
						<input
							...
							className="appearance-none outline-none bg-input placeholder-shown:font-nunito placeholder-shown:font-[400] placeholder-shown:text-[18px] placeholder-shown:leading-[27px] xl:w-[500px] md:w-[300px] w-full  py-3 px-4"
						/>
					</div>
