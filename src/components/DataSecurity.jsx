...
const DataSecurity = () => {
  return (
    <Section>
      <div className="flex lg:flex-row flex-col-reverse w-full font-nunito items-center lg:justify-around justify-center pt-14 pb-52 gap-y-24 px-5">
        {/* Left Image */}
        ...
        {/* Right Text */}
        <div className="lg:w-[32%] w-full lg:text-start text-center">
